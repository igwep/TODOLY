...
const HeroSection = () => {
  return (
    <section className="bg-customColor text-gray-800 py-2 md:py-16 flex justify-center items-start px-8 w-full md:px-20  md:h-[70vh] h-auto relative">
  ...
  <div className="bg-white bg-opacity-10 w-32 h-32 sm:w-56 sm:h-56 rotate-12 absolute bottom-20 sm:bottom-32 right-5 sm:right-10 rounded-sm floating-animation"></div>
      ...
      <div className="    w-full flex flex-col-reverse md:flex-row items-center relative z-10">
        ...
        <div className="md:w-1/2 w-full flex justify-center md:justify-end relative mt-10 md:mt-0">
          ...
          <img
            ...
            className="w-[80%] sm:w-[90%] max-w-md absolute top-4 left-4 sm:top-6 sm:left-6 scale-110 opacity-50"
          />
